...
For `0.3.1`, the outputs are:

| Destination | Name |
| --- | --- |
| npm | `ether-state@0.3.1`, tag `latest` |
| GitHub Release | Title `v0.3.1`, tag `v0.3.1` |
| GitHub Packages | `@0xjimmy/ether-state@0.3.1` |

The publish job is named `Release v0.3.1`. The deployment environment is named
